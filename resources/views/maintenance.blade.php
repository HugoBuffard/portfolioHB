  ...
  <div id="hero" class="hero route bg-image" style="background-color: black;">
    ...
    <div class="hero-content display-table">
      <div class="table-cell">
        <div class="container">
          <h1 class="hero-title mb-4">Portfolio en maintenance ...</h1>
          <p class="hero-subtitle"><span class="typed" data-typed-items="Bientôt de retour,Partir pour mieux revenir,:-)"></span></p>
        </div>
      </div>
    </div>
